    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="max-w-2xl mx-auto text-muted-foreground">
          We leverage battle-tested open-source technologies and cutting-edge
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        {techs.map((t, i) => (
          <div
            key={t.name}
            className="flex flex-col items-center text-center bg-card rounded-xl p-6 card-elevated opacity-0 animate-fade-in-up"
